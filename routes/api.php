...
use App\Http\Controllers\ReservationExtensionController;
    ...
    Route::post('/reservations/{id}/extensions', [ReservationExtensionController::class, 'requestExtension']);
    Route::put('/extensions/{id}/approve', [ReservationExtensionController::class, 'approveExtension']);
    Route::put('/extensions/{id}/decline', [ReservationExtensionController::class, 'declineExtension']);
